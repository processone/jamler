...
(* OASIS_START *)
(* DO NOT EDIT (digest: b0a264bf8fe6740f9343f7ad84ffb1d8) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "pa_jlib";
                           InternalLibrary "pa_sql";
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("lwt.lib", None);
                      ...
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib =
                        [(OASISExpr.EBool true, ["-lexpat"; "-lidn"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git+ssh://git@gitorious.process-one.net/jamler/jamler.git";
                      src_repo_browser =
                        Some "https://gitorious.process-one.net/jamler";
                      src_repo_module = None;
                      src_repo_branch = Some "master";
                      src_repo_tag = None;
                      src_repo_subdir = Some "."
                   })
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "2\150_\206\139\130ieF\230}(q\222\247\246";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
